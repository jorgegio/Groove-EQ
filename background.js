...
initBandBiquads = function() {
	...
	cTabObj.band1.frequency.setValueAtTime(
		frequencies[0],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band2.type = "peaking";
	cTabObj.band2.frequency.setValueAtTime(
		frequencies[1],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band3.type = "peaking";
	cTabObj.band3.frequency.setValueAtTime(
		frequencies[2],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band4.type = "peaking";
	cTabObj.band4.frequency.setValueAtTime(
		frequencies[3],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band5.type = "peaking";
	cTabObj.band5.frequency.setValueAtTime(
		frequencies[4],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band6.type = "peaking";
	cTabObj.band6.frequency.setValueAtTime(
		frequencies[5],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band7.type = "peaking";
	cTabObj.band7.frequency.setValueAtTime(
		frequencies[6],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band8.type = "peaking";
	cTabObj.band8.frequency.setValueAtTime(
		frequencies[7],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band9.type = "peaking";
	cTabObj.band9.frequency.setValueAtTime(
		frequencies[8],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band10.type = "peaking";
	cTabObj.band10.frequency.setValueAtTime(
		frequencies[9],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band11.type = "peaking";
	cTabObj.band11.frequency.setValueAtTime(
		frequencies[10],
		cTabObj.audioCtx.currentTime
	);
	cTabObj.band12.type = "highshelf";
	cTabObj.band12.frequency.setValueAtTime(
		frequencies[11],
		cTabObj.audioCtx.currentTime
	);
...
chrome.runtime.onMessage.addListener(function(element) {
	...
	if (element.type) {
		...
		if (cTabObj.stream) {
			switch (element.type) {
				case "band1":
					cTabObj.band1.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band2":
					cTabObj.band2.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band3":
					cTabObj.band3.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band4":
					cTabObj.band4.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band5":
					cTabObj.band5.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band6":
					cTabObj.band6.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band7":
					cTabObj.band7.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band8":
					cTabObj.band8.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band9":
					cTabObj.band9.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band10":
					cTabObj.band10.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band11":
					cTabObj.band11.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
				case "band12":
					cTabObj.band12.gain.setValueAtTime(
						element.value,
						cTabObj.audioCtx.currentTime
					);
					break;
